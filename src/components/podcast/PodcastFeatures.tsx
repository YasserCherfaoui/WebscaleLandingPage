...
const features = [
  {
    ...
    title: "محتوى متخصص",
    description: "حلقات مخصصة لأرباب الأعمال حول الذكاء الاصطناعي والتجارة الإلكترونية مع خبراء محليين ودوليين"
  },
  {
    icon: ShieldHalf,
    title: "مجتمع حصري",
  ...
  },
  {
    icon: Users,
    title: "شبكة علاقات",
    description: "تواصل مباشر مع خبراء الصناعة وأصحاب المشاريع الناجحة في مجال التجارة الإلكترونية"
  },
  {
    icon: Clock,
    title: "محتوى محدث",
    description: "حلقات أسبوعية تتناول أحدث التطورات والتقنيات في مجال الذكاء الاصطناعي والتجارة الإلكترونية"
  },
  {
    icon: Headphones,
    title: "استماع مرن",
    description: "استمع إلى الحلقات في أي وقت ومن أي مكان، مع إمكانية التحميل للاستماع بدون إنترنت"
  },
  {
    icon: TrendingUp,
    title: "نتائج عملية",
    description: "تعلم استراتيجيات قابلة للتطبيق فوراً لتحسين أعمالك وزيادة أرباحك"
  },
  {
    icon: Globe,
    title: "رؤى عالمية",
  ...
  },
  {
    icon: Zap,
    title: "أدوات مجانية",
    description: "احصل على أدوات وموارد مجانية لمساعدتك في تطبيق ما تتعلمه في أعمالك"
  }
];
